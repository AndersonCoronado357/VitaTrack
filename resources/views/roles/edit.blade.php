    ...
    <section class="section">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body mt-3">
                ...
                <form action="{{ route('roles.update') }}" class="row g-3 mt-3" method="POST" id="frmEdit">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" placeholder="Nombre" name="name" value="{{ $role->name }}" />
                                <label>Nombre</label>
                            </div>
                        </div>
